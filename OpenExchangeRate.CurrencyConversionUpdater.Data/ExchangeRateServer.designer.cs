...
namespace OpenExchangeRate.CurrencyConversionUpdater.Data
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="OpenExchangeRateServer")]
	public partial class ExchangeRateServerDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void OnCreated();
		...
		public ExchangeRateServerDataContext() : 
				base(global::OpenExchangeRate.CurrencyConversionUpdater.Data.Properties.Settings.Default.OpenExchangeRateServerConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public ExchangeRateServerDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ExchangeRateServerDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ExchangeRateServerDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ExchangeRateServerDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<ExchangeRatesServer> ExchangeRatesServers
		{
			get
			{
				return this.GetTable<ExchangeRatesServer>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ExchangeRatesServer")]
	public partial class ExchangeRatesServer
	{
